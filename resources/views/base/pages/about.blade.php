...
<main>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="about-thumb">
                            <img src="{{asset('base\assets\images\about\about.jpg')}}" alt="about thumb">
                        </div>
                    </div>
                    <div class="col-lg-7">
        ...
        <section class="testimonial-area section-padding bg-img" data-bg="{{asset('base/assets/img/testimonial/testimonials-bg.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- section title start -->
            ...
            <div class="container">
                ...
                <div class="row mbn-30">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('base\assets\images\team\team_member_1.jpg')}}" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('base\assets\images\team\team_member_2.jpg')}}" alt="">
                                <div class="team-social">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-linkedin"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('base\assets\images\team\team_member_3.jpg')}}" alt="">
                                <div class="team-social">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-linkedin"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member mb-30">
                            <div class="team-thumb img-full">
                                <img src="{{asset('base\assets\images\team\team_member_4.jpg')}}" alt="">
                                <div class="team-social">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-linkedin"></i></a>
