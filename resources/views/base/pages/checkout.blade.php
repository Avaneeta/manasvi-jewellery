                            ...
                            <div class="order-summary-content">
                                ...
                                <div class="order-summary-table table-responsive text-center">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="{{ url('/product_details') }}">Suscipit Vestibulum <strong> × 1</strong></a>
                                                </td>
                                                <td>Rs 16500.00</td>
                                            </tr>
                                            <tr>
                                                <td><a href="{{ url('/product_details') }}">Ami Vestibulum suscipit <strong> × 4</strong></a>
                                                </td>
                                                <td>Rs 16500.00</td>
                                            </tr>
                                            <tr>
                                                <td><a href="{{ url('/product_details') }}">Vestibulum suscipit <strong> × 2</strong></a>
                                                </td>
                                                <td>Rs 16500.00</td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label" for="paypalpayment">Paypal <img src="{{asset('base\assets\images\paypal-card.jpg')}}" class="img-fluid paypal-card" alt="Paypal" /></label>
                                            </div>
                                        </div>
