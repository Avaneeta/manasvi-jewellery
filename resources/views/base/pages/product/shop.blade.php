                        ...
                        <aside class="sidebar-wrapper">
                            ...
                            <div class="sidebar-banner">
                                <div class="img-container">
                                    <a href="#">
                                        <img src="{{asset('base\assets\images\banner\sidebar-banner.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                            <!-- single sidebar end -->
                            ...
                            <div class="shop-product-wrap grid-view row mbn-30">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="{{ url('/product_details') }}">Platinum</a></p>
                                            </div>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Platinum</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h5 class="product-name"><a href="{{ url('/product_details') }}">Perfect Diamond Jewelry</a></h5>
                                            <div class="price-box">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="{{ url('/product_details') }}">Quickiin</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Diamond</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h5 class="product-name"><a href="{{ url('/product_details') }}">Handmade Golden Necklace</a></h5>
                                            <div class="price-box">
                                                <span class="price-regular">Rs 5000.00</span>
                                                <span class="price-old"><del>Rs 2009.99</del></span>
                                            </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Quickiin</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h5 class="product-name"><a href="{{ url('/product_details') }}">Diamond Exclusive Ornament</a></h5>
                                            <div class="price-box">
                                                <span class="price-regular">Rs 5000.00</span>
                                                <span class="price-old"><del>Rs 2009.99</del></span>
                                            </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="{{ url('/product_details') }}">BDevs</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">BDevs</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="{{ url('/product_details') }}">Hastech</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Gold</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Silver</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="{{ url('/product_details') }}">Maya</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Maya</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="{{ url('/product_details') }}">Jem</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="{{ url('/product_details') }}">Jem</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
